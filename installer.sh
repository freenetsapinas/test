...
# Change mo na lang dito ung banner file mo boss, pang dropbear lang ung banner, wala sa ssh
wget -qO /etc/banner "https://raw.githubusercontent.com/username/repository/main/SSHBanner"
...
#Dito boss ung DB ng OVPN Change mo na lang boss
cat <<\EOM7 >/etc/openvpn/script/config.sh
#!/bin/bash
HOST='66.45.251.234'
USER='zoeyoffi_michaele'
PASS='WU2&_n8?.^Yc'
DB='zoeyoffi_michaele'
EOM7
...
function InstBadVPN(){
    # Change link boss ng badvpn-udpgw
curl -skL "https://github.com/freenetsapinas/test/raw/main/badvpn-udpgw" -o /usr/local/bin/badvpn-udpgw 
	chmod +x /usr/local/bin/badvpn-udpgw
    # Change link boss ng badvpn-udpgw.service
	curl -skL "https://raw.githubusercontent.com/freenetsapinas/test/main/badvpn-udpgw.service" -o /lib/systemd/system/badvpn-udpgw.service
...
RESPONSE = 'HTTP/1.1 101 <font color="purple">Silent Developer</font>\r\n\r\nContent-Length: 104857600000\r\n\r\n'
...
# Paltan mo ung link boss kung san mo inupload ung Menu zip
wget -q 'https://github.com/freenetsapinas/test/raw/main/zoey.zip'
unzip -qq zoey.zip
rm -f zoey.zip
chmod +x ./*
dos2unix ./* &> /dev/null
...
function OVPNFixer(){
 ...
 # Paltan mo ung link boss kung san mo inupload ung OVPN FIXER
 wget -qO /etc/openvpn/ovpn_fixer.bash "https://raw.githubusercontent.com/freenetsapinas/test/main/ovpn_fixer.bash"
...
echo -e "#     Setup by: Silent Developer                 #"
echo -e "#       Server System: Silent Developer              #"
...
echo ""
echo -e "${GREEN}BadVPN-UDPGW         = 7300 ${RESET}"
echo ""
...
EOM
#Prem.sh file mo dito boss
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/test/main/prem.sh -q
}
...
[ "$user_name" != '' ] && [ "$user_name" = "$username" ] && echo "user : $username" && echo 'authentication ok.' && exit 0 || echo 'authentication failed.'; exit 1
EOM
#VIP.sh file mo dito boss
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/test/main/vip.sh -q
}
...
[ "$user_name" != '' ] && [ "$user_name" = "$username" ] && echo "user : $username" && echo 'authentication ok.' && exit 0 || echo 'authentication failed.'; exit 1
EOM
#Private.sh file mo dito boss
wget -O /usr/local/sbin/ssh.php https://raw.githubusercontent.com/freenetsapinas/test/main/private.sh -q
}
